...
<head>
    ...
    <title>SUBWAY - Edit Employee</title>
    <style>
        .text-white-bold {
            color: white;
            font-weight: 750;
...
<body style="background-color: #006989;">
    ...
    <div class="container">
        <div class="text-center mb-4 text-white">
            <h3>Edit Employee</h3>
            <p class="text-white">Complete the Form to edit the employee details</p>
        </div>
            ...
            <form action="update_employee.php" method="post" style="width: 50vw; min-width: 200px; background-color: #005C78; border-radius: 10px; padding: 20px;">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="lastName" value="<?php echo htmlspecialchars($last_name); ?>" required>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="department" id="department" required>
                        <option value="<?php echo htmlspecialchars($department); ?>" selected><?php echo htmlspecialchars($department); ?></option>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="project" id="project" required>
                        <option value="<?php echo htmlspecialchars($project); ?>" selected><?php echo htmlspecialchars($project); ?></option>
                        <!-- Options will be dynamically populated by JavaScript -->
                    </select>
                </div>
                <div class="mb-3">
                    ...
                    <select class="form-control" name="task" id="task" required>
                        <option value="<?php echo htmlspecialchars($task); ?>" selected><?php echo htmlspecialchars($task); ?></option>
                        <!-- Options will be dynamically populated by JavaScript -->
                    </select>
                </div>
                <div>
